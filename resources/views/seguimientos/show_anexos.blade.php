...
<div class="col-md-10">
    <div class="row">
        ...
        <hr>
        @if($action == 'edit')
                <h3>Archivos del Seguimiento</h3>
                        ...
                        <tr>
                            ...
                            <td>
                              ...
                              @if ("{{ $anexo->user_id }}"  == "{{ $user_id }}")
                                    <a href="{{ route('anexoSeguimiento.deletefile', $anexo->slug) }}" class="btn btn-danger btn-xs pull-rigth" onclick="return confirm('Está seguro que desea eliminar este Archivo?')">BORRAR</a>
                              @endif
