...
<div class="row">
  <div class="form-group col-sm-8">
      <table id="table" class="table table-striped table-bordered">
          ...
          <tbody>
              <tr>
                  <td> {!! Form::text('puesta_en_marcha_nuevo_ampliacion', null, ['class' => 'form-control']) !!} </td> <!-- N o A -->
                  <td> {!! Form::select('puesta_en_marcha_si_no_parcial', [''=>'Seleccione', 'SI'=>'SI', 'NO'=>'NO', 'PARCIAL' => 'PARCIAL'], null, ['class' => 'form-control', 'id' => 'tipo_proyecto', 'data-live-search' => 'true', 'data-max-options' => '1']  )  !!} </td>
        ...
        <ul class="list-group">
            <li class="list-group-item">
                ...
                <div class="material-switch pull-right">
                    @if ($action == 'create')
                      <input type="checkbox" name="problema_1" id="problema_1>
                    @else
            ...
            <li class="list-group-item">
                ...
                <div class="material-switch pull-right">
                    @if ($action == 'create')
                      <input type="checkbox" name="problema_2" id="problema_2">
                    @else
            ...
            <li class="list-group-item">
                ...
                <div class="material-switch pull-right">
                  @if ($action == 'create')
                      <input type="checkbox" name="problema_3" id="problema_3">
                  @else
            ...
            <li class="list-group-item">
                ...
                <div class="material-switch pull-right">
                  @if ($action == 'create')
                      <input type="checkbox" name="problema_4" id="problema_4">
                  @else
            ...
            <li class="list-group-item">
                ...
                <div class="material-switch pull-right">
                  @if ($action == 'create')
                      <input type="checkbox" name="problema_5" id="problema_5">
                  @else
            ...
            <li class="list-group-item">
                ...
                <div class="material-switch pull-right">
                  @if ($action == 'create')
                      <input type="checkbox" name="problema_6" id="problema_6">
                  @else
            ...
            <li class="list-group-item">
                ...
                <div class="material-switch pull-right">
                  @if ($action == 'create')
                      <input type="checkbox" name="problema_7" id="problema_7">
                  @else
...
<div class="row">
    <div class="form-group col-sm-11">
          {!! Form::textarea('10_2_describir_razones_consignadas', null, ['class' => 'form-control', 'rows' => 3, 'data-toggle'=>'tooltip', 'data-placement'=>'bottom']) !!}
      ...
      <table id="table" class="table table-striped table-bordered">
          ...
          <tbody>
              <tr>
                  ...
                  <td> {!! Form::select('inv_previstas_si_no', [''=>'Seleccione', 'SI'=>'SI', 'NO'=>'NO', 'PARCIAL' => 'PARCIAL'], null, ['class' => 'form-control', 'id' => 'inv_previstas_si_no', 'data-live-search' => 'true', 'data-max-options' => '1']  )  !!} </td>
                  <td id="porcentaje_desvio"> {!! Form::text('inv_previstas_desvios', null, ['class' => 'form-control']) !!} </td> 
              </tr>
    ...
    <div class="form-group col-sm-7">
        <ul class="list-group">
            <li class="list-group-item">
                ...
                <div class="material-switch pull-right">
                    @if ($action == 'create')
                      <input type="checkbox" name="desvio_inv_problema_1" id="desvio_inv_problema_1">
                    @else
            ...
            <li class="list-group-item">
                ...
                <div class="material-switch pull-right">
                    @if ($action == 'create')
                      <input type="checkbox" name="desvio_inv_problema_2" id="desvio_inv_problema_2">
                    @else
            ...
            <li class="list-group-item">
                ...
                <div class="material-switch pull-right">
                  @if ($action == 'create')
                      <input type="checkbox" name="desvio_inv_problema_3" id="desvio_inv_problema_3">
                  @else
            ...
            <li class="list-group-item">
                ...
                <div class="material-switch pull-right">
                  @if ($action == 'create')
                      <input type="checkbox" name="desvio_inv_problema_4" id="desvio_inv_problema_4">
                  @else
            ...
            <li class="list-group-item">
                ...
                <div class="material-switch pull-right">
                  @if ($action == 'create')
                      <input type="checkbox" name="desvio_inv_problema_5" id="desvio_inv_problema_5">
                  @else
            ...
            <li class="list-group-item">
                ...
                <div class="material-switch pull-right">
                  @if ($action == 'create')
                      <input type="checkbox" name="desvio_inv_problema_6" id="desvio_inv_problema_6">
                  @else
            ...
            <li class="list-group-item">
                ...
                <div class="material-switch pull-right">
                  @if ($action == 'create')
                      <input type="checkbox" name="desvio_inv_problema_7" id="desvio_inv_problema_7">
                  @else
            ...
            <li class="list-group-item">
                ...
                <div class="material-switch pull-right">
                  @if ($action == 'create')
                      <input type="checkbox" name="desvio_inv_problema_8" id="desvio_inv_problema_8">
                  @else
...
<div class="row">
    <div class="form-group col-sm-11">
          {!! Form::textarea('11_2_describir_razones_consignadas', null, ['class' => 'form-control', 'rows' => 3, 'data-toggle'=>'tooltip', 'data-placement'=>'bottom']) !!}
