<div class="col-md-11" style="border-bottom: 2px solid #cccccc">
      <div class="row">
         ...
         <div class="form-group col-sm-3">
                 ...
                 {!! Form::text('fechaRespuestaBanco', null, ['class' => 'form-control fechas', 'readOnly']) !!}
         </div>
         <div class="form-group col-sm-3">
      ...
      <div class="row">
           <div class="form-group col-sm-3">
                   ...
                   {!! Form::text('fechaCaducoBanco', null, ['class' =>'form-control fechas'] ) !!}
           </div>
           <div class="form-group col-sm-3">
                   {!! Form::label('fechaAprobadoUep', 'Aprobado UEP') !!}
                   {!! Form::text('fechaAprobadoUep', null, ['class' => 'form-control fechas']) !!}
           </div>
           <div class="form-group col-sm-3">
                   {!! Form::label('fechaEnviadoCfi', 'Envío al CFI') !!}
                   {!! Form::text('fechaEnviadoCfi', null, ['class' => 'form-control fechas']) !!}
           </div>
           <div class="form-group col-sm-3">
                   {!! Form::label('fechaAprobadoCfi', 'Aprobado CFI') !!}
                   {!! Form::text('fechaAprobadoCfi', null, ['class' => 'form-control fechas']) !!}
           </div>
      ...
      <div class="row">
            <div class="form-group col-sm-3">
                    ...
                    {!! Form::text('fechaTramdispo', null, ['class' => 'form-control fechas']) !!}
            </div>
           <div class="form-group col-sm-3">
                   {!! Form::label('fechaComunicaTran', 'COMUNICATRAN') !!}
                   {!! Form::text('fechaComunicaTran', null, ['class' =>'form-control fechas'] ) !!}
           </div>
           <div class="form-group col-sm-3">
                   {!! Form::label('fechaDesembolso', 'Desembolso') !!}
                   {!! Form::text('fechaDesembolso', null, ['class' => 'form-control fechas']) !!}
           </div>
           <div class="form-group col-sm-3">
                   {!! Form::label('fechaEfectivizacion', 'Efectivización') !!}
                   {!! Form::text('fechaEfectivizacion', null, ['class' => 'form-control fechas']) !!}
           </div>
      ...
      <div class="row">
            <div class="form-group col-sm-3">
                    ...
                    {!! Form::text('fechaDesistido', null, ['class' => 'form-control fechas']) !!}
            </div>
            <div class="form-group col-sm-3">
                    {!! Form::label('fechaJudicial', 'JUDICIAL') !!}
                    {!! Form::text('fechaJudicial', null, ['class' =>'form-control fechas'] ) !!}
            </div>

            <div class="form-group col-sm-3">
                   {!! Form::label('fechaCancelado', 'Cancelado') !!}
                   {!! Form::text('fechaCancelado', null, ['class' => 'form-control fechas']) !!}
            </div>
            <div class="form-group col-sm-3">
                   {!! Form::label('fechaArchivado', 'Archivado') !!}
                   {!! Form::text('fechaArchivado', null, ['class' => 'form-control fechas']) !!}
            </div>
      </div>
      <div class="row">
            <div class="form-group col-sm-3">
