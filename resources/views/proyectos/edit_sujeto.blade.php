                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="form-group col-sm-3">
                            ...
                            <input type="text" class="form-control fechas" name="fechaEnvioSujetoAjax" id="fechaEnvioSujetoAjax" />
                        </div>
                        <div class="form-group col-sm-3">
                            <label  class="control-label" for="monto">Respuesta Banco</label>
                            <input type="text" class="form-control fechas" name="fechaRespuestaSujetoAjax" id="fechaRespuestaSujetoAjax" />
                        </div>
                        <div class="form-group col-sm-3">
