        ...
        <div class="col-md-11">
            <div class="panel panel-default">
                ...
                <div style="margin-top: 85px;">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <a href="{{ route('seguimiento.create1', $proyecto->id) }}" type="button" class="btn btn-primary pull-right">Nuevo Seguimiento</a>
                    ...
                    <table id="table" class="table table-striped table-bordered" style="margin-left: 15px; width: 95%;">
                        ...
                        <tr>
                            <th>Fecha</th>
                            <th>Nro Entrevista</th>
                            <th>Grado Morosidad</th>
                        ...
                        @foreach($seguimientos as $td)
                            <tr>
                                <td>{{ \Carbon\Carbon::parse($td->fecha_seguimiento)->format('d-m-Y') }}</td>
                                <td>{{ $td->nroEntrevista }}</td>
                                <td>{{ $td->grado_morosidad }}</td>
