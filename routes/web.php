...
Route::group(['middleware' => 'auth'], function ()
{
    ...
    Route::group(['prefix' => 'seguimiento'], function () {
            Route::get('listado', 'SeguimientoController@index')->name('seguimiento.index')->middleware('permission:seguimiento.index');
            Route::get('nuevo', 'SeguimientoController@create')->name('seguimiento.create')->middleware('permission:seguimiento.create');
            Route::get('nueva/{id}', 'SeguimientoController@create1')->name('seguimiento.create1')->middleware('permission:seguimiento.create1');
            Route::post('nuevo', 'SeguimientoController@store')->name('seguimiento.store')->middleware('permission:seguimiento.store');
            Route::get('editar/{seguimiento}', 'SeguimientoController@edit')->name('seguimiento.edit')->middleware('permission:seguimiento.edit');
            Route::get('editar1/{id}', 'SeguimientoController@editar')->name('seguimiento.editar')->middleware('permission:seguimiento.editar');
            Route::get('ver/{seguimiento}', 'SeguimientoController@show')->name('seguimiento.show')->middleware('permission:seguimiento.show');
            Route::patch('editar/{seguimiento}', 'SeguimientoController@update')->name('seguimiento.update')->middleware('permission:seguimiento.update');
            Route::get('eliminar/{seguimiento}', 'SeguimientoController@destroy')->name('seguimiento.delete')->middleware('permission:seguimiento.delete');
            Route::post('search', 'SeguimientoController@search')->name('seguimiento.search')->middleware('permission:seguimiento.search');
    ...
    */
    ...
    Route::group(['prefix' => 'profile'], function () {
        ...
        Route::get('eliminar/{profile}', 'ProfileController@destroy')->name('profile.delete')->middleware('permission:profile.destroy');
